...
const initial: WaitlistEntry = { name: '', email: '', studio: '', city: '', photographyType: 'Photography studio', consent: false }
...
export function WaitlistForm() {
  ...
  return (
    <form className="waitlist-form" onSubmit={submit}>
      ...
      <label>Creator type<select value={form.photographyType} onChange={(e) => update('photographyType', e.target.value)}><option>Photography studio</option><option>Wedding</option><option>Portrait</option><option>Fashion</option><option>Commercial</option><option>Fine art</option><option>Content creator</option><option>Other</option></select></label>
